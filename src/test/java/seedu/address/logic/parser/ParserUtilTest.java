...
public class ParserUtilTest {
    ...
    @Test
    public void parseName_invalidValue_throwsParseStudentException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseStudentName(INVALID_NAME));
    }

    @Test
    public void parseName_validValueWithoutWhitespace_returnsStudentName() throws Exception {
        Name expectedName = new Name(VALID_NAME);
        assertEquals(expectedName, ParserUtil.parseStudentName(VALID_NAME));
    }

    @Test
    public void parseName_validValueWithWhitespace_returnsTrimmedStudentName() throws Exception {
