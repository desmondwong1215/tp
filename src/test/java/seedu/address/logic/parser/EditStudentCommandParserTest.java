...
public class EditStudentCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB
                + GENDER_DESC_AMY + NAME_DESC_AMY;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withGender(VALID_GENDER_AMY).build();
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + GENDER_DESC_AMY
                + PHONE_DESC_AMY + GENDER_DESC_AMY
                + PHONE_DESC_BOB + GENDER_DESC_BOB;
