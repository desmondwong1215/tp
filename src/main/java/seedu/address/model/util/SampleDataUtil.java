...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Gender("female"), new StudentId("S00003")),
            new Person(new Name("David Li"), new Phone("91031282"), new Gender("male"), new StudentId("S00004")),
