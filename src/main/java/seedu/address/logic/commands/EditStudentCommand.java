...
public class EditStudentCommand extends Command {
    ...
    public static final String MESSAGE_ID_IS_IMMUTABLE = "Student's id cannot be edited";
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        StudentId originalStudentId = personToEdit.getStudentId(); // Preserve the original student ID

        return new Person(updatedName, updatedPhone, updatedGender, originalStudentId);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, gender);
        }
